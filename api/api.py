...
# Update this endpoint to use the new utility
...
async def get_local_repo_structure(
    ...
    return_chunks: bool = Query(
        False, description="Return chunked structure for large repos")
):
    """
    ...
    try:
        # Use shared logic
        result = await analyze_local_repository(path, chunk_size, return_chunks)
        return result
